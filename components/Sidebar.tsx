  ...
  const categories: MenuCategory[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'Validation Cotisations Antérieures', label: 'Validation Cotisations Antérieures', icon: <Clock size={20} /> },
