  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      const defaults: Record<string, string[]> = {
        ...
        'caissier': ['Membres', 'Analyse', 'Déblocage de crédit', 'Crédit actif', 'Tontine Journalière', 'Vente Livrets', 'Gestion Caisse', 'Dépenses administratives', 'Frais & Parts Sociales', 'Journal Global', 'Reçu de caisse', 'Etats des écarts', 'Rapports Financiers', 'Notification'],
